...
const notes = `
  ...
  <p>This is a content component which allows the users to place a group of images together.</p>
  <h3>HTML Example</h3>
  <code>
    ${renderHTML(
      `<ccdesign-carousel data='[Array Of Object]' time-interval='time'></ccdesign-carousel>`,
    )}
    <br/>
...
const stories = storiesOf("Content|Carousel", module)
