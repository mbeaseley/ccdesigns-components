...
const welcome = () => {
  return `
    <div class="bodyContainer">
      ...
      ${renderTable([
        ["Carousel", "A component that holds a mininum of 3 images and will slide each one by one to center and repeat."],
        ["Copy", "A component that holds html allowed text that can be placed in any location."],
        ["Footer", "This is a key component for the template and will exist at the bottom of a webpage."],
        ["Grid", "A component that can hold other components in a formatted structure on a page."],
        ["Header", "This is a key component for the template and will exist at the top of any page."],
        ["Image Card", "A component that holds image and label which is a link to external pages."],
        ["Social Container", "A component that is used to hold an icon to act as a link to a external page."],
      ])}
      <h3 style="font-size: 14px; margin-top: 10px;">Data Components</h3>
      ${renderTable([
        ["Placeholder", "A component that is a placeholder for other components."],
      ])}
      ...
      ${renderTable([
        ["CV Template", "A component that sets the structure for a webpage, including header and footer."],
      ])}
