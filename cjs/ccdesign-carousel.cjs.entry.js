...
const CcdesignCarousel = class {
    ...
    getData(carouseData) {
        ...
        returnItems = items.map((item) => (index.h("div", { id: item.id, title: item.alt, style: { backgroundImage: `url(${item.image})` }, class: 'slides slide-out-right' })));
        return returnItems;
    }
    componentWillLoad() {
    ...
    render() {
        return index.h("div", { class: 'carousel' }, this.dataElement);
    }
    get el() { return index.getElement(this); }
};
CcdesignCarousel.style = ccdesignCarouselCss;

exports.ccdesign_carousel = CcdesignCarousel;
