...
const CcdesignImageCard = class {
     ...
     */
    render() {
        const image = (h("div", { class: 'image-card__image' }, h("ccdesign-lazy-image", { "img-src": `${this.imageUrl}`, alt: `${this.imageAlt}` })));
        const description = (h("div", { class: 'image-card__description' }, h("p", null, this.description)));
